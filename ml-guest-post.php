 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Safan Guest Post
 * Plugin URI:        https://wprashed.com/plugin
 ...
 * The tgm include.
 */
include_once 'lib/class-tgm-plugin-activation.php';
...
function ml_guest_post_register_required_plugins() {
...
add_action( 'tgmpa_register', 'ml_guest_post_register_required_plugins' );
